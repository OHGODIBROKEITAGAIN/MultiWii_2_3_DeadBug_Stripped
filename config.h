...
/*************************************************************************************************/
  ...
  /****************************    Motor minthrottle    *******************************/
    ...
    #define MINTHROTTLE 1060 // for DeadBug
...
// TO DO: servo to control FPV camera pitch?
  ...
  /***********************          Airplane                       ***********************/
/* NOTE!!! THE FOLLOWING HAVE BEEN COMMENTED OUT AND (as of 20160923) are untested:
    #define FLAPPERON_EP
    #define FLAPPERON_INVERT
   DELETE "Airplane" SECTION IF TEST SUCCESSFULL
 */
...
/* NOTE!!! THE FOLLOWING HAVE BEEN COMMENTED OUT AND (as of 20160923) ARE UNTESTED:
 ...
 #define COLLECTIVE_RANGE
 #define YAWMOTOR
 #define SERVO_NICK   { +10, -10,  0 }
 #define SERVO_LEFT   { +10, +5, +10 }
 #define SERVO_RIGHT  { +10, +5, -10 }
 
 DELETE "Heli" SECTION IF TEST SUCCESSFULL
 */
 ...
 */
  ...
  /*************************    INFLIGHT ACC Calibration    *****************************/
    ...
    //#define INFLIGHT_ACC_CALIBRATION
                        ...
                        // INVESTIGATE ASSIGNING TO Tx SWITCH
...
// Following line commented out by RTA
...
//#define GPS_LED_INDICATOR
    ...
    // Following 3 lines commented out by RTA
    ...
    // Following 2 lines commented out by RTA
...
//Uncomment following 7 lines to activate the vbat code
    //#define VBAT
...
// Following 2 #define lines commented out by RTA
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
	...
	//#define EXT_MOTOR_32KHZ // only 511 steps + on your own risk!       Benedikt Default
...
// Following line commented out by RTA - uncomment if servos are implemented on DeadBug
...
// Following line commented out by RTA - uncomment if servos are implemented on DeadBug | UNTESTED
